  ...
  return useMemo(() => {
    ...
    return {
      container: {
        ...
        style: {
          ...containerStyle,
          marginTop: isEdgeToEdge() || (statusBarTranslucent ?? false) ? undefined : -statusBarHeight,
          marginBottom: isEdgeToEdge() || (navigationBarTranslucent ?? false) ? undefined : -navigationBarHeight
        }
      },
      logo: {
        ...logo,
