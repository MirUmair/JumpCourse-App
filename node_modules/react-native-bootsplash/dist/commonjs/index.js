...
function useHideAnimation(config) {
  ...
  return (0, _react.useMemo)(() => {
    ...
    if (__DEV__) {
      ...
      if ((0, _reactNativeIsEdgeToEdge.isEdgeToEdge)() && (hasStatusBarOption || hasNavigationBarOption)) {
        console.warn(hasBothOptions ? "statusBarTranslucent and navigationBarTranslucent options are ignored when using react-native-edge-to-edge" : `${hasStatusBarOption ? "status" : "navigation"}BarTranslucent option is ignored when using react-native-edge-to-edge`);
      }
    }
    return {
      container: {
        ...
        style: {
          ...containerStyle,
          marginTop: (0, _reactNativeIsEdgeToEdge.isEdgeToEdge)() || (statusBarTranslucent ?? false) ? undefined : -statusBarHeight,
          marginBottom: (0, _reactNativeIsEdgeToEdge.isEdgeToEdge)() || (navigationBarTranslucent ?? false) ? undefined : -navigationBarHeight
        }
      },
      logo: {
        ...logo,
